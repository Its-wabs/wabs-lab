...
const BlurReveal = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="blur-reveal font-display absolute right-8 bottom-14 left-8 text-[clamp(2rem,6vw,5rem)] leading-[0.88] font-black text-[#161412] uppercase">
        Blur
        <br />
        <span className="text-[#A59676] italic">Reveal.</span>
      </h1>
