...
export default function FadeInPattern() {
  ...
  return (
    ...
    >
      ...
      <h1 className="fade font-display absolute right-8 bottom-14 left-8 text-[clamp(2rem,6vw,5rem)] leading-[0.88] font-black text-[#161412] uppercase">
        Fade
        <br />
